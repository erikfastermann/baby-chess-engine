...
impl Board {
    pub fn start() -> Self {
        ...
        let board = Self {
            black: PlayerBoard {
                rooks: Bitset::from_index(position::BLACK_ROOK_LEFT_STARTING_INDEX)
                ...
                king: Bitset::from_index(position::BLACK_KING_STARTING_INDEX),
                pawns: black_pawns,
            ...
            white: PlayerBoard {
                rooks: Bitset::from_index(position::WHITE_ROOK_LEFT_STARTING_INDEX)
                ...
                king: Bitset::from_index(position::WHITE_KING_STARTING_INDEX),
                pawns: white_pawns,
                can_castle: CanCastle {
                    left: true,
                    right: true,
